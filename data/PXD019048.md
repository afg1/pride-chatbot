...
### Title
A2M-3K DSSO cross-linking to identify the bait region position

### Description
An A2M mutant, A2M-3K, with the bait region arginines replaced with lysines, was cross-linked with DSSO. Its monomeric gel band was analyzed by XL-MS to identify the bait region position within a subunit.
...
### Data Protocol
Cross-linked peptides were identified in the MS data files with Proteome Discoverer (version 2.4 for samples digested with trypsin and GluC or trypsin alone, and version 2.3 for samples digested with both trypsin and chymotrypsin, as 2.4 cannot handle 4< substrate residues) and the XlinkX node, using established processing and consensus workflows for analysis of MS2_MS3 spectra with MS-cleavable cross-links (20). The false discovery rate was set to 0.01, 3 missed cleavages were allowed for tryptic samples and 5 missed cleavages were allowed for the combination digests, and methionine oxidation and asparagine deamidation (to account for removed N-glycans) were included as variable modifications. A2M’s original N-terminal at position 24 and neo-N-termini in the bait region after tryptic cleavage (positions 705, 716, and 720) were included as possible cross-linking sites. Misassignment of dead-end cross-links to cross-links between lysines at the same position were observed and manually corrected. Crosslink identifications with less than 3 cross-link spectral matches were filtered out. Crosslinks involving ambiguous peptides (peptides that occur more than once in the A2M sequence) were not included.
