...
### Title
Multiomics analysis of naturally efficacious LNP coronas reveals high-density lipoprotein is necessary for LNP function. Individual corona

### Description
The MS data set contains the result from each individual rat plasma derived corona used in the publication, titled Multiomics analysis of naturally efficacious LNP coronas reveals high-density lipoprotein is necessary for LNP function.
