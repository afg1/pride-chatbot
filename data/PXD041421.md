...
The A549 and K562 cell lines (National Collection of Authenticated Cell Cultures, China) were cultured in Ham's F-12K medium (Invitrogen, USA) and Iscove's modified Dulbecco's medium (Invitrogen, USA) separately, supplemented with 10% fetal bovine serum and 1% penicillin-streptomycin. Cells were split into three dishes as biological replicates, then washed with phosphate-buffered saline and collected by centrifugation for three times.
...
### Keywords
Dda, K562, Pasef, A549, Dia, Batch effects
