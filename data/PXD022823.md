...
### Description
Phosphoproteomics of mouse liver over a period of four hours after insulin administration. It is part of a larger project that contains multi-omic datasets.

### Sample Protocol
Protein extracts from mouse liver were digested with trypsin. Phosphopeptides enriched by IMAC were then analyzed via LC-MS/MS on LTQ-Velos-Orbitrap mass spectrometer.

### Data Protocol
Peptides were identified using MaxQuant and filtered at 1% FDR via the target-decoy approach.
