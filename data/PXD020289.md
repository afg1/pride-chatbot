...
### Title
NanoToxClass: Investigation of dose- and time-dependent nanomaterial effects in alveolar epithelial cells

### Description
In this study, alveolar epithelial cells (cell line RLE-6TN) were treated with three different doses of nanomaterials (SiO2_15_Amino, SiO2_15_Unmod, SiO2_7, SiO2_40, TiO2_NM105) for 6 h, 24 h, and 48 h, respectively. The effects were investigated using untargeted proteomics.

### Sample Protocol
Proteins were extracted from the cells, and TMT labeling was used for protein quantification. The LC-MS/MS analysis was conducted on a nano-UPLC system (Ultimate 3000, Dionex, USA) coupled online to the mass spectrometer (QExactive HF, Thermo Scientific, USA) via a chip-based electrospray ionization source (Nanomate, Advion, USA).
...
### Keywords
Rat, Nanotoxclass, Epithelial cells, Nanomaterials, Tmt
