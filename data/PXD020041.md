...
### Affiliations
['University of Dundee', 'Cell Signalling & Immunology, School of Life Sciences, University of Dundee']

### Submitter
['Alejandro Brenes']

### Lab Head
[{'title': 'Dr', 'affiliation': 'Cell Signalling & Immunology, School of Life Sciences, University of Dundee', 'email': 'd.a.cantrell@dundee.ac.uk', 'country': '', 'orcid': '', 'name': 'Doreen Cantrell', 'id': '203620100'}]

### SDRF
characteristics[organism]: ['Mus musculus']
characteristics[organism part]: ['T cells']
...
comment[modification parameters]: ['NT=TMT10plex;PP=Any N-term;AC=UNIMOD:737;MT=fixed']
...
comment[modification parameters].3: ['not available']
comment[modification parameters].4: ['not available']
