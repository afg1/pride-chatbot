...
### Lab Head
[{'title': 'Dr', 'affiliation': 'Nanyang Technological University, Singapore', 'email': 'sksze@ntu.edu.sg', 'country': '', 'orcid': '', 'name': 'Prof Sze S K', 'id': '128160100'}]

### SDRF
characteristics[organism]: ['Homo sapiens']
characteristics[disease]: ['Non-demented control' "Alzheimer's diseasemedial" "Alzheimer's disease"]
characteristics[organism part]: ['brain']
characteristics[organism part].1: ['medial frontal gyrus']
