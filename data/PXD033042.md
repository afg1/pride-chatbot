...
### Affiliations
['Biochemistry II, Theodor Boveri-Institute, Biocenter, University of Würzburg, 97074 Würzburg, Germany', 'University of Wuerzburg\nChair of Biochemistry II\nAm Hubland\n97074 Würzburg']

### Submitter
['Julian Bender']

### Lab Head
[{'title': 'Dr', 'affiliation': 'Biochemistry II, Theodor Boveri-Institute, Biocenter, University of Würzburg, 97074 Würzburg, Germany', 'email': 'bettina.warscheid@uni-wuerzburg.de', 'country': '', 'orcid': '', 'name': 'Bettina Warscheid', 'id': '2383138'}]

### SDRF
characteristics[organism]: ['NT=Trypanosoma brucei;AC=NCBITAXON:5691']
characteristics[organism part]: ['NT=Cell Line; AC=CLO:0000031']
characteristics[disease]: ['not applicable']
characteristics[cell type]: ['not applicable']
comment[label]: ['SILAC light ' 'SILAC heavy']
comment[label].1: ['SILAC heavy' 'SILAC light ']
comment[instrument]: ['NT=Q Exactive Plus;AC=MS:1002634']
comment[modification parameters]: ['NT=Carbamidomethyl; MT=Variable; AC=Unimod:4; TA=C']
comment[modification parameters].1: ['NT=Oxidation; MT=Variable; AC=Unimod:35; TA=M']
