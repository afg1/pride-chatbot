...
### SDRF
- organism: NT=Trypanosoma brucei;AC=NCBITAXON:5691
- organism part: NT=Cell Line; AC=CLO:0000031
- disease: not applicable
- cell type: not applicable
- label: SILAC light , SILAC heavy
- label.1: SILAC heavy, SILAC light 
- instrument: NT=Q Exactive Plus;AC=MS:1002634
- modification parameters: NT=Carbamidomethyl; MT=Variable; AC=Unimod:4; TA=C
- modification parameters.1: NT=Oxidation; MT=Variable; AC=Unimod:35; TA=M
