...
### Title
Identification of circGlis3 binding proteins in MS-1 cells by LC-MS

### Description
To identify the potential circGlis3 binding proteins, we extracted the total protein from MS-1 cells and performed RNA Pull-down assay. Then RNA-interacting proteins were subjected to mass spectrometry.
...
### Keywords
Lc-ms, Circglis3, Rna binding proteins, Ms-1 cell
