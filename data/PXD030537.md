...
### Data Protocol
Results of each representative experiment were analyzed by ANOVA, using the statistical software package SPSS version 24. A significance level of 95% was considered to indicate a statistical difference. The Tukey test was performed to evaluate the significance of difference among mean values when a significant variation (p<0.05) was found by the ANOVA test. Each treatment underwent three replicated measurements for which the mean values ± standard error of mean were obtained
