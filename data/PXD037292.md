...
### Title
Identification of a novel protein circINSIG1-121 in hunan colorectal cancer cell by LC-MS

### Description
To identify a novel protein circINSIG1-121, we extracted the proteins from HCT8 cells, and then the proteins were subjected to mass spectrometry
...
### Keywords
Lc-ms, Circinsig1-121, Hunan colorectal cancer cell
