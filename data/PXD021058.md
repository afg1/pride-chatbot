...
### Title
Identification of Merlin binding proteins
...
### Sample Protocol
The cells and empty vector-transduced LN229 cells were treated with DMSO or thapsigargin for 15 minutes and subjected to immunoprecipitation by a Flag antibody. Immunoprecipitated products were resolved using SDS polyacrylamide gel electrophoresis, followed by staining with GelCode Blue Stain Reagent (Thermo Scientific). For each sample/gel lane, all protein bands were separated into two groups along the 80 kDa protein weight marker, and separately excised from the gel. In each gel slice, proteins were digested in situ by trypsin. The purified peptides were then subjected to nano-liquid chromatography coupled to tandem mass spectrometry (LC-MS).

### Data Protocol
Protein/peptide identifications from the LC-MS data were performed using the Global Proteome Machine (https://www.thegpm.org/).
...
### Keywords
Immunoprecipitation, Calcium, Nf2, Merlin
