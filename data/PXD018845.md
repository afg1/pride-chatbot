...
### Sample Protocol
leaves samples were collected at 12 hpi (no infected leaves as control), stained with 0.05% aniline blue and observed under an epifluorescence microscope. the leaves of LB and PN were inoculated with P. viticola and then stained with 3, 3-diaminobenzidine (DAB) solution.total proteins of infected and mock leaves in resistant genotype LB and susceptible genotype PN were extracted at 12h and their profiles were explored using the iTRAQ technique.To validate the iTRAQ results, four differently expression proteins were analysed using PRM in LB and PN at 12 hpi and control.

### Data Protocol
Differently expressed proteins (DEPs) were based on a quantification ratio > 1.2 or < 0.83 at p value < 0.05 with at least one unique peptide in at least two biological replicates.Among the 709 DEPs, 538 were characterized as hypothetical or unknown proteins under grape genomics information category in Uniprot (http://www.uniprot.org/). To gain functional information about these proteins, BLAST (http://www.ncbi.nlm.nih.gov/BLAST/) was used to search for homologous proteins against the NCBI non redundant (Nr) protein database. In order to gain a more detailed description, MapMan was used to conduct the functional annotation and classification of the DEPs.To validate the iTRAQ results, four differently expression proteins were analysed using PRM in LB and PN at 12 hpi and control.
