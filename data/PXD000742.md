...
### Title
Caudate nucleus proteome -  Anatomo-proteomic characterization of human basal ganglia: focus on striatum and globus pallidus

### Description
In order to analyse thecaudate nucleus proteome in a large-scale format, we used a multi-dimensional fractionation approach which combines isolation of anatomically-defined nuclei, and protein/peptide chromatographic  fractionation strategies coupled to mass spectrometry.
