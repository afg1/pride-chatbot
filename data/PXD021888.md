...
### Data Protocol
Mass spectral data were acquired using Xcalibur (v.2.2 SP1). MS raw files were processed with the MaxQuant software suite (version 1.4.1.2) for label-free quantification using 'match between runs'. Data was filtered to 1% FDR

### Publication Abstract
None

### Keywords
Pellet, Secretome, Cbpd
