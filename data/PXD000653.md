...
### Title
CSF proteome mapping: Human cerebrospinal fluid LC-MS/MS, Part 3

### Description
3 mL CSF from a pool of 21 neurologically healthy donors was in-solution trypsin digested followed by Solid-phase enrichment of N-linked glycopeptides (SPEG) using hydrazide modified beads. Glycopeptides were further fractionated into 20 fractions by mixed-mode reversed phase anion exchange (MM(RP-AX) using a Promix MP column. Each fraction was analyzed separately by LC-MS/MS on an Orbitrap Velos Pro mass spectrometer. Resulting data was searched using SeachGui, summarized in PeptideShaker and exported to the CSF-PR.
