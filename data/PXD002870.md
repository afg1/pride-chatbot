...
### Affiliations
['The NIH BD2K Center of Excellence in Biomedical Computing at UCLA The NHLBI Proteomics Center at UCLA University of California at Los Angeles', 'UCLA']

### Submitter
['Edward Lau']

### Lab Head
[{'title': 'Dr', 'affiliation': 'The NIH BD2K Center of Excellence in Biomedical Computing at UCLA The NHLBI Proteomics Center at UCLA University of California at Los Angeles', 'email': 'admin@heartbd2k.org', 'country': '', 'orcid': '', 'name': 'Peipei Ping', 'id': '30040100'}]
...
comment[label]: ['NT=metabolic label;AC=PRIDE:0000597']
...
comment[modification parameters].2: ['NT=Acetyl;AC=UNIMOD:1;TA=K;MT=variable']
comment[modification parameters].3: ['NT=Phospho;MT=variable;TA=S,T,Y;AC=UNIMOD:21']
comment[modification parameters].4: ['NT=Deamidated;MT=variable;TA=N;AC=UNIMOD:7']
