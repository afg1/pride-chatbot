...
### Sample Protocol
For identification of acetylation site, stably expressed Flag-p62 was purified from HCT116 cells with or without hMOF-overexpression by Flag-M2 beads, and analyzed by LC-MS/MS.

### Data Protocol
Mascot was used to analysis data. Database: human database downloaded from Uniprot.org  Digestion enzyme: trypsin. Mass tolerance: 10 ppm for precursor ions and 0.6 Da for fragment ions. Maximum missed cleavages: 2. Fixed modifications: Carbamidomethyl (Cys). Variable modification:  acetylation (Lys), oxidation (Met).
