...
### Title
NanoLC-MSMS Phosphoproteomics comparison of in vitro cultured reticulocytes before and after passage through microfluidic capillaries

### Description
Triplicate samples (biological replicates) of in vitro culture-derived reticulocytes (derived from CD34+ cells) were analysed through qualitative phosphoproteomics before and after passage through a microfluidics capillary chip to investigate the mechanisms underlying shear stress recognition.
...
### Keywords
Human, Erythrocyte, Erythropoiesis, Nanolc-msms, Phospho, Red blood cell, Reticulocyte
