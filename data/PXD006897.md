...
### Title
Shotgun proteomics analysis of single human tubules

### Description
We analyzed microdissected single tubules from human with shotgun proteomics.

### Sample Protocol
We lysed human tubules in SDS and subjected them to reduction, alkylation, tryptic digestion and nLC-MS/MS. For details, see the method section of the respective paper.

### Data Protocol
We analyzed the data by MaxQuant. For details, see the method section of the respective paper.
