...
### Title
CPTAC, TCGA Cancer Proteome Study of Colorectal Tissue: Proteome, VU, part 5
...
### Lab Head
[{'title': 'Dr', 'affiliation': 'Vanderbilt University', 'email': 'daniel.liebler@Vanderbilt.Edu', 'country': '', 'orcid': '', 'name': 'Daniel C. Liebler, Ph.D.', 'id': '20720100'}]

### SDRF
Characteristics[organism]: ['Homo sapiens']
Characteristics[organism part]: ['Sigmoid Colon' 'Ascending Colon']
...
comment[modification parameters1]: ['NT=Carbamidomethyl;AC=UNIMOD:4;TA=C;MT=Fixed']
