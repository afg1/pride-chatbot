...
### Affiliations
['Princess Margaret Cancer Centre', 'Neuropathologist, Department of Pathology, University Health Network Assistant Professor, Department of Laboratory Medicine and Pathobiology, University of Toronto Scientist, Princess Margaret Cancer Centre']

### Submitter
['MICHAIL PAPAIOANNOU']

### Lab Head
[{'title': 'Dr', 'affiliation': 'Neuropathologist, Department of Pathology, University Health Network Assistant Professor, Department of Laboratory Medicine and Pathobiology, University of Toronto Scientist, Princess Margaret Cancer Centre', 'email': 'p.diamandis@mail.utoronto.ca', 'country': '', 'orcid': '', 'name': 'Phedias Diamandis', 'id': '135440100'}]
...
comment[modification parameters].3: ['NT=Phospho;AC=UNIMOD:21;MT=Variable;TA=S']
comment[modification parameters].4: ['NT=Phospho;AC=UNIMOD:21;MT=Variable;TA=T']
comment[modification parameters].5: ['NT=Phospho;AC=UNIMOD:21;MT=Variable;TA=Y']
comment[modification parameters].6: ['NT=Ubiquitination;AC=UNIMOD:853;MT=Variable,TA=K']
